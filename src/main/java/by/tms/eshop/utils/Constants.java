...
//    @SuppressWarnings({"checkstyle:MultipleStringLiterals", "checkstyle:AnnotationLocation"}) public static final String AUTHORIZATION_PATTERN = "[a-zA-Z0-9]{14,30}";
    public static final String NAMES_PATTERN = "[a-zA-Z0-9]{3,30}";
//    public static final String NAMES_PATTERN = "[a-zA-Z0-9]{13,30}";
